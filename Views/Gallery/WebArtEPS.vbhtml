...
<script>
    function download1() {
        ...
        if (r == true) {
            window.open("https://illustrate.net/bulldogs/Content/Catagories/Gallery/WebArt/Eps/BD-Logo-Master-Black.zip")
        } else {}
    }
    ...
    function download2() {
        ...
        if (r == true) {
            window.open("https://illustrate.net/bulldogs/Content/Catagories/Gallery/WebArt/Eps/BD-Logo-Master-White.zip")
        } else {}
    }
</script>