...
@Using Html.BeginForm("AddPhoneNumber", "Manage", FormMethod.Post, New With { .class = "form-horizontal", .role = "form" })
    ...
    <div class="form-group row py-2">
        @Html.LabelFor(Function(m) m.Number, New With {.class = "col-md-2 control-label py-2"})
        <div class="col-md-10">
    ...
    <div class="form-group row py-2">
        <div class="col-md-offset-2 col-md-10">
            <input type="submit" class="btn btn-default bg-dark text-light mt-5" value="Submit" />
        </div>
    </div>
    </text>
End Using
