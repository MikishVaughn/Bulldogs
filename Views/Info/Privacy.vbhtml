...
<div style="font-family: 'Knockout 31 4r', HelveticaNeue-CondensedBold, Helvetica, Arial, sans-serif; font-weight: 400; color: black; margin-left: auto; margin-right: auto; text-align: center; max-width: 90%;">
    ...
    <div style="padding: 5px; width: 98%; text-align: left; color: black;">
        ...
        <div class="p_div">
            ...
            <button class="noborder bg-transparent text-white" id="newTab" onclick="newTab('https://support.google.com/adwordspolicy/answer/1316548?hl=en')">Click Here for More Info.</button>
        </div>
        <div class="p_div">
        ...
        <div class="p_div">
            ...
            it is being shared, and to comply with this policy. -  <button class="noborder bg-transparent text-white" id="newTab" onclick="newTab('http://consumercal.org/california-online-privacy-protection-act-caloppa/#sthash.0FdRbT51.dpuf')">Click Here for More Info.</button>
        </div>
